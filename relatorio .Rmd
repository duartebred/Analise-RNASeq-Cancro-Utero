...
# Assumindo que 'rna_seq_UCEC' é o seu objeto de dados

# Use cat() para exibir tudo em um bloco
cat("Class of rna_seq_UCEC:", class(rna_seq_UCEC), "\n",
    "Dimensions of rna_seq_UCEC:", paste(dim(rna_seq_UCEC), collapse=" x "), "\n",
    "First 5 column names of rna_seq_UCEC:", paste(colnames(rna_seq_UCEC)[1:5], collapse=", "), "\n",
    "First 5 row names of rna_seq_UCEC:", paste(rownames(rna_seq_UCEC)[1:5], collapse=", "), sep="\n")
