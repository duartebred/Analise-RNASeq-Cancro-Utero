...
Segundo a sumarização dos resultados, nas condições estabelecidas, foram indentificados no total 3431 genes, sendo que desses {} se encontram sobreexpressos e os restantes subexpressos.
...
A visualização dos resultados a nível gráfico

Graficamente, através do MA plot, conseguimos visualizar essa diferença na expressão dos genes, sendo que os pontos a azul correspondem aos genes diferencialmente expressos e os pontos a cinza correspondem a outros genes. Para os genes sobre-expressos temos então uma condição em que esses genes estão mais expressos na condição "Dead" do que na condição "Alive" e para os genes sub-expressos temos o inverso, ou seja, os genes em questão estão sub-expressos na condição "Alive".
