...
Em datasets desta natureza estamos perante conjutnos de dados com altas dimensões no que diz respeito ao número de células e genes.Nem todos os genes são informativos e importantes para a tarefa de agrupamento de tipos celulares com base em seus perfis de expressão, levando apenas à redundância dos dados. A técnica de PCA leva a que as variávies com menor variância seja descartadas para reduzir efetivamente a dimensionalidade dos dados sem perder informações, eliminando a redundância.
...
```
No nosso caso, podemos verificar que tendo 423 variáveis, necessitaríamos apenas de 20 componentes principais para explicar pelo menos 95% da variabilidade dos nossos dados.
