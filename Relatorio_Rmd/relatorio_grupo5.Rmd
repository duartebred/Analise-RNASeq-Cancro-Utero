...
**Refazer tudo e tirar novas concluões**

```{r, echo=FALSE}
pcares1 = prcomp(dados_EA_CPM, scale = F)
...
No nosso caso, verificou-se que das 423 amostras, necessitaríamos apenas de 20 componentes principais para explicar pelo menos 95% da variabilidade dos nossos dados.
...
No entanto, através do biplot desses dois componentes, não se consegui verificar nenhuma divisão clara dos dados.
