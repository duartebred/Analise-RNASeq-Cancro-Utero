...
Neste trabalho vamos utilizar 3 modelos distintos de machine learning (N-Nearest Neighbors, Naive Bayes, Random Forest) para prever com base nos dados de expressão genética se um determinado paciente se encontra no estado alive ou dead, sendo que apenas o melhor modelo vai ser utilizado na previsão final.
...
#confusion_matrix = confusionMatrix(pred_knn, data_set_teste$vital) dá erro
